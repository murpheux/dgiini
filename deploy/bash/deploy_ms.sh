...
tar -zxvf qtaskr_$1/ms/dist/qtaskr_microservices-0.1.0.tar.gz --directory install/install_$1/$2/ms/auth  --strip 1
cp qtaskr_$1/ms/dist/version.txt install/install_$1/$2/ms/auth/

mkdir -p install/install_$1/$2/ms/task
cp -r install/install_$1/$2/ms/auth/* install/install_$1/$2/ms/task
cp qtaskr_$1/ms/dist/version.txt install/install_$1/$2/ms/task/

mkdir -p install/install_$1/$2/ms/notify
cp -r install/install_$1/$2/ms/auth/* install/install_$1/$2/ms/notify
cp qtaskr_$1/ms/dist/version.txt install/install_$1/$2/ms/notify/

mkdir -p install/install_$1/$2/ms/bill
cp -r install/install_$1/$2/ms/auth/* install/install_$1/$2/ms/bill
cp qtaskr_$1/ms/dist/version.txt install/install_$1/$2/ms/bill/
